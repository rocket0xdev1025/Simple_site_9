    ...
    /***/ 605338: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        ...
        var TTb = function (a, b, c) {
          ...
          e4 = function (a, b) {
            a = a.u_a.get(b);
            if (a == null) throw new VTb("ref does not exists");
            return a;
          },
          h4 = function (a) {
            const b = (c, d) => {
            ...
            return {
              Dl: (c) => ({ type: "string", value: c }),
              Rt: (c) => b(c, "toWidgetState"),
              Qt: (c) => b(c, "toWidgetData"),
              Xv: (c) => b(c, "toWidgetData"),
            };
          },
          j4 = function (a, b) {
            if (a.length === 0)
            ...
            return {
              Dl: (e) => ({ type: "string", value: e }),
              Rt: (e) => d(e, "toWidgetState"),
              Qt: (e) => d(e, "toWidgetData"),
              Xv: (e) => d(e, "toWidgetData"),
            };
          },
          k4 = function (a) {
            const b = (c, d) => {
            ...
            return {
              Dl: (c) => {
                if (!Number.isFinite(c)) throw new WTb(c);
            ...
            return {
              ...
              Rt: (d) => {
                if ((d === null || d === void 0 ? void 0 : d.type) !== "dict")
                  throw new g4("record", d);
                const e = {};
                for (const f of Object.keys(a)) {
                  const [g, h] = a[f],
                    k = h.Rt(d.value.get(g));
                  k != null && (e[f] = k);
                }
                return e;
              },
          ...
          o4 = function (a) {
            return {
              Dl: (b) => ({ type: "list", value: b.map((c) => a.Dl(c)) }),
              Rt: (b) => {
                if ((b === null || b === void 0 ? void 0 : b.type) !== "list")
                  throw new g4("list", b);
                return b.value.filter(wb).map((c) => a.Rt(c));
              },
              Qt: (b) => {
                if ((b === null || b === void 0 ? void 0 : b.type) !== "list")
                  throw new f4("list", b);
          ...
          ZTb = function (a) {
            return {
              Dl: (b) => {
                if (b != null) return a.Dl(b);
              },
              Rt: (b) => {
                if (b != null) return a.Rt(b);
              },
              Qt: (b) => {
                if (b != null) return a.Qt(b);
              },
              Xv: (b) => {
                if (b != null) return a.Xv(b);
              },
            };
          },
          p4 = function (a, b) {
          ...
          $Tb = function (a) {
            const b = () => a.jk.UA.get(a.Af.mH) || q4;
            return {
              qU: function () {
                return a.jk.gk
                  ? 3
                  : a.jk.nfb === "checking" || a.jk.settings.status === 2
                  ? 1
                  : a.jk.settings.status === 3
                  ? 4
                  : a.jk.K2
                  ? 2
                  : 0;
          ...
          dUb = function (a, b, c, d, e, f) {
            ...
            async function h() {
              var w;
              const u = f.Ak("submit_response", {
                RA: { name: "ui.rendering.form.submit_response" },
              });
              var x = {
                Bqa: m,
                rcb: p,
              ...
              e && UTb({ span: u, qa: e, event: aUb, props: x });
              const { results: y, Hf: A, Uwa: z } = r();
              if (A != null && g())
                if (
                  (x =
                    (w = a.Af.fields.first(({ value: H }) => {
                      var M;
                      return !(
                        (M = H.options.first(({ value: O }) => O.id === A)) ===
                          null ||
                        M === void 0 ||
                        !M.value
                      );
                  ...
                  p === "poll" &&
                    z &&
                    z !== A &&
                    (E = r4({ qma: y, qF: x.id, SV: z }));
                  E = bUb({ PJa: E, qF: x.id, SV: A });
                  l("field_results_created", u);
                  s4(() => {
                    a.Zm(() => ({
                      UA: t({ Hf: A, CL: A, results: E }),
                      K2: !0,
                    }));
                  });
                  l("submission_set", u);
                  ...
                  var I = await c.HGb({
                    ...
                    byb: {
                      qF: x.id,
                      En: x.label.text.ba.trim(),
                      Hf: A,
                      options: x.options.map(({ value: H }) => ({
                        id: H.id,
                        label: H.label.text.ba.trim(),
                      })),
                    },
                  });
                  if (I.ok)
                    return s4(() => {
                      const H = (M) => {
                        var O;
                        return (O = I.value[0]) === null || O === void 0
                          ? void 0
                          : O.Qzb.includes(M);
                      };
                      a.Zm(() => ({
                        K2: !1,
                        settings: { ...a.jk.settings, Aca: H },
                        UA: t({ Uwa: void 0 }),
                      }));
                    });
                  d === null ||
                    ...
                    __c.zj(d, {
                      rv: P("izckBA"),
                      group: cUb,
                      bS: { Qy: P("mQhziQ"), onClick: h },
                    });
                  var K = r4({ qma: E, qF: x.id, SV: A });
                  z && (K = bUb({ PJa: K, qF: x.id, SV: z }));
                  s4(() => {
                    a.Zm({
                      ...B,
                      ...(z && { UA: t({ Hf: z, CL: z, results: K }) }),
                    });
                  });
                } else u.abort();
              else u.abort();
            ...
            async function k(w) {
              ...
              const x = r(),
                y =
                  (u = a.Af.fields.first(({ value: B }) => {
                    var E;
                    return !(
                      (E = B.options.first(({ value: I }) => I.id === w)) ===
                        null ||
                      E === void 0 ||
                      !E.value
                    );
              ...
              if (y) {
                var A = a.jk,
                  z = r4({ qma: x.results, qF: y.id, SV: w });
                s4(() => {
                  a.Zm(() => ({
                    UA: t({ Hf: void 0, CL: void 0, results: z }),
                    xB: void 0,
                    K2: !0,
                  }));
                });
            ...
            return {
              ...
              via: function (w) {
                const u = r(),
                  x =
                    p === "poll" &&
                    w === (u === null || u === void 0 ? void 0 : u.Hf) &&
                    w === (u === null || u === void 0 ? void 0 : u.CL);
                if (g() && x) k(w);
                else if (
                  g() &&
                  a.Af.fields.some(({ value: A }) =>
                    A.options.some(({ value: z }) => z.id === w)
                  )
                ) {
                  var y = u === null || u === void 0 ? void 0 : u.CL;
                  s4(() => {
                    const A = r();
                    a.Zm(() => ({
                      UA: t({ Uwa: y, Hf: A.Hf === w ? void 0 : w }),
                    }));
                  });
                  p === "poll" && h();
                }
              ...
              jea: function (w) {
                g() &&
                  a.Af.fields.some(({ value: u }) =>
                    u.options.some(({ value: x }) => x.id === w)
                  ) &&
                  a.Zm(() => ({ IF: w }));
              },
              lea: function (w) {
              ...
              hea: function (w) {
                const { CL: u, Hf: x } = r();
                b.qU() === 0 &&
                  a.Af.fields.some(({ value: y }) =>
                    y.options.some(({ value: A }) => A.id === w)
                  ) &&
                  x !== w &&
                  !u &&
                  a.Zm(() => ({ xB: w }));
          ...
          r4 = function ({ qma: a, qF: b, SV: c }) {
            var d;
            const e =
              (d = a.fields.get(b)) !== null && d !== void 0
                ? d
                : { id: b, BK: new Map(), total: 0 };
            var f;
            d = Math.max(
              0,
              ((f = e.BK.get(c)) !== null && f !== void 0 ? f : 0) - 1
            );
            f = new Map(e.BK);
          ...
          bUb = function ({ PJa: a, qF: b, SV: c }) {
            ...
            const e =
              (d = a.fields.get(b)) !== null && d !== void 0
                ...
                : { id: b, BK: new Map(), total: 0 };
            var f;
            d = ((f = e.BK.get(c)) !== null && f !== void 0 ? f : 0) + 1;
            return {
              fields: t4(a.fields, b, {
                id: b,
                BK: t4(e.BK, c, d),
          ...
          u4 = function (a, b) {
            var c;
            return (((c = a.Fia) === null || c === void 0
              ? void 0
              : c.get(a.document.language || "en")) || [])[eUb[b]];
          },
          fUb = function (a) {
            u4(a, "yourNameWontBeShared") || P("Gzs/9g");
          },
          gUb = function (a) {
            u4(a, "yourNameWillBeShared") || P("WjcAyg");
          },
          hUb = async function () {
            var { CCa: a } = await __webpack_require__
              .me(535189)
              .then(() => ({
              ...
              m.push({
                ...
                placement: a
                  ? {
                      ...
                      gridRowStart: `${p + q}`,
                      gridRowEnd: `${p + q + 1}`,
                      padding: t.padding ? iUb(t.padding) : void 0,
          ...
          iUb = function (a) {
            switch (a.length) {
              ...
              case 1:
                return a[0];
              case 2:
                return { Ca: a[0], Ta: a[1], La: a[0], Ba: a[1] };
              case 4:
                return { Ca: a[0], Ta: a[1], La: a[2], Ba: a[3] };
              default:
          ...
          w4 = function (a, b) {
            ...
            return __c.Rr(b, (d) => {
              var e;
              const f =
                (e = c.get(d)) !== null && e !== void 0 ? e : __c.st(d, a);
              c.set(d, f);
              return f;
            });
          },
          y4 = function (a, b) {
            ...
            __c.v(!0);
            __c.v(!0);
            const { na: c, a: d, b: e } = __c.nt(a),
              { na: f, a: g, b: h } = __c.nt(b),
              k = (c + f) / 2;
          ...
          z4 = function (a) {
            switch (a.type) {
              case "color":
                return a.color;
              case "gradient":
                return a.pb.lm[0].color;
              default:
                throw new F(a);
            }
          },
          A4 = function (a, b) {
            a = __c.tk.create(__c.tk.xa(a.text));
            b != null && a.Al(b);
            return { type: "text", OD: 1, text: __c.tk.xa(a) };
          },
          B4 = function (a) {
            switch (a) {
              case "l":
          ...
          lUb = function ({ direction: a, text: b, background: c }) {
            return {
              id: "header",
              size: "auto",
              fill: c,
              padding: [20, 20, 16, 20],
              content: A4(b, { direction: C4(a) }),
            };
          },
          oUb = function ({
            direction: a,
            ...
            g === 3 || g === 4 || g === 5
              ? ((b = (n = u4(b, "resultsPercentage"))
                  ? TTb(n, [e], b.document.language)
                  : __c.Gb("sUWUOA", [e])),
                (k = {
                  id: "percentage",
                  placement: {
            ...
            switch (b) {
              ...
              case 1:
                return {
                  type: "text",
                  OD: 1,
                  text: D4(a.messages.loading(), c, d, w4(e, rUb), f),
                };
              case 2:
                return {
                  type: "text",
                  OD: 1,
                  text: D4(
                    u4(a.messages, "submitting") || P("wutQEA"),
                    c,
                    d,
                    w4(e, rUb),
                    f
              ...
              case 3:
                return {
                  type: "text",
                  OD: 1,
                  text: D4(a.messages.offline(), c, d, w4(e, sUb), f),
                };
              case 4:
                return {
                  type: "text",
                  OD: 1,
                  text: D4(
                    u4(a.messages, "somethingWentWrong") || P("ElTceA"),
                    c,
                    d,
                    w4(e, tUb),
                    f
          ...
          vUb = function ({
            ...
            d = h ? TTb(h, [d], b.document.language) : __c.Gb("6QpLYA", [d]);
            return [
              {
                id: "footer",
                size: "auto",
          ...
          zUb = function ({ direction: a, Vva: b, Wx: c, state: d }) {
            const e = y4("#000000", c);
            return {
              type: "layout",
              gridTemplateRows: ["10px", "1fr", "10px"],
              ...
              cells: [
                {
                  ...
                  content: (() => {
                    switch (d) {
                      case 5:
                        return A4(b, { direction: C4(a), color: "#00873d" });
                      case 6:
                        return A4(b, { direction: C4(a), color: "#c8001e" });
                      case 4:
                        return A4(b, { direction: C4(a), color: w4(c, yUb) });
                      default:
                        return A4(b, { direction: C4(a) });
                    }
                  })(),
                },
                d === 5 || d === 6
                  ...
                  return {
                    ...
                    content: {
                      ...
                      onMouseUp: () => {
                        ...
                        return a === null || a === void 0
                          ? void 0
                          : (u = a.mea) === null || u === void 0
                          ? void 0
                          : u.call(a, p.id);
                      },
                      ...zUb({ direction: b, Vva: p.label, Wx: k, state: q }),
                    },
                  };
                }),
              }),
          ...
          BUb = function ({ direction: a, text: b, D6a: c, DS: d, rO: e }) {
            const f = x4.includes(c),
              { h: g, s: h, na: k } = __c.Kja(c);
            ...
            return {
              ...
              content: jUb({
                direction: B4(a),
                Zl: e === null || e === void 0 ? void 0 : e.submit,
                onMouseEnter: e === null || e === void 0 ? void 0 : e.sua,
                onMouseLeave: e === null || e === void 0 ? void 0 : e.tua,
                onMouseDown: e === null || e === void 0 ? void 0 : e.rua,
                onMouseUp: e === null || e === void 0 ? void 0 : e.uua,
                background: {
                  type: "color",
                  color: d === 2 ? m : d === 1 ? l : c,
            ...
            if (!m || !h || !k)
              return (
                ...
                (h === null || h === void 0 ? void 0 : h.status) === 1
                  ...
                  : void 0,
                [
                  BUb({ direction: b, text: e, D6a: k, DS: n, rO: a }),
                  {
                    id: "quiz_status",
                    size: "auto",
                    padding: [8, 20, 10, 20],
                  ...
                  cells: [
                    {
                      ...
                      content: {
                        ...
                        fontFamily: d,
                        text: h.Aca(k)
                          ? u4(c, "correctLabel") || P("i3mNPA")
                          : u4(c, "incorrectLabel") || P("As1GTA"),
                        fontSize: CUb,
                        fontWeight: "bold",
                        textAlign: "center",
                        direction: C4(b),
        ...
        __c.qD.prototype.wwa = __c.ea(12, function () {
          return __c.lD(this, () => __c.YC(this.operators, "%", this.value));
        });
        var EUb = class {
            constructor() {
              this.type = "layout";
        ...
        var n4 = class {
            ...
            toArray() {
              return this.mKa.map(({ value: a }) => a);
            }
            first(a) {
              const b = this.list.value.first(
                a ? (c) => a(d4(this, c)) : void 0
              );
            ...
            constructor(a, b) {
              this.GA = b;
              this.A_a = (n4.A(this), new WeakMap());
              this.u_a = new WeakMap();
              __c.C(a.type === "list");
              this.list = a;
            }
          },
          YTb = class extends n4 {
            replace(a, b) {
              a = e4(this, a);
              b = this.list.value.replace(a, this.GA.Dl(b));
              return d4(this, b);
            }
            nO(a, b) {
              a = a != null ? e4(this, a) : void 0;
              b = this.list.value.nO(a, this.GA.Dl(b));
              return d4(this, b);
            }
            oO(a, b) {
              a = a != null ? e4(this, a) : void 0;
              return this.list.value
                .oO(
                  a,
                  b.map((c) => this.GA.Dl(c))
                )
                .map((c) => d4(this, c));
            }
            insertBefore(a, b) {
              a = a != null ? e4(this, a) : void 0;
              b = this.list.value.insertBefore(a, this.GA.Dl(b));
              return d4(this, b);
            }
            append(a) {
              a = this.list.value.append(this.GA.Dl(a));
              return d4(this, a);
            }
            prepend(a) {
              a = this.list.value.prepend(this.GA.Dl(a));
              return d4(this, a);
            }
            delete(a) {
              a = e4(this, a);
        ...
        var HUb = m4({
              ...
              (function () {
                const a = (b) => {
                  if (
                    ...
                    throw new f4("text2", b);
                  return b.value;
                };
                return {
                  Dl: (b) => ({ type: "text2", value: b }),
                  Rt: (b) => {
                    if (
                      (b === null || b === void 0 ? void 0 : b.type) !== "text2"
                    )
                      throw new g4("text2", b);
                    return b.value;
                  },
                  Qt: a,
                  Xv: a,
          ...
          G4 = p4({ text2: HUb }, (a) => a.type),
          IUb = m4({ id: ["i", h4("")], label: ["l", G4] }),
          JUb = o4(IUb),
          KUb = o4(h4("")),
          LUb = m4({
              ...
              (function () {
                const a = (b) => {
                  if (
                    ...
                    throw new f4("stroke", b);
                  return b.value;
                };
                return {
                  Dl: (b) => ({ type: "stroke", value: b }),
                  Rt: (b) => {
                    if (
                      (b === null || b === void 0 ? void 0 : b.type) !==
                      "stroke"
                    )
                      throw new g4("stroke", b);
                    return b.value;
                  },
                  Qt: a,
                  Xv: a,
        ...
        j4(["poll", "quiz"], "quiz");
        var UUb = p4({ quiz: SUb, poll: TUb }, (a) => a.type),
          q4 = {
            Hf: void 0,
            CL: void 0,
            Uwa: void 0,
        ...
        var aUb = {
          ...
          cg(a) {
            return __c.is({
              ...
              action: a.action,
              location: a.location,
              linked_design_id: a.kGb,
              toggle_value: a.uH,
              editing_context: a.pe == null ? void 0 : __c.js(a.pe),
              performance_context: a.pg == null ? void 0 : __c.ks(a.pg),
            });
          },
        };
        var cUb = Symbol("UNABLE_TO_SUBMIT");
        var eUb = {
            resultsPercentage: 0,
        ...
        var XUb = class {
          ...
          get border() {
            ...
            return { weight: a.border.weight, color: a.border.color, $Wa: a.X };
          }
          constructor(a, b) {
            this.fz = a;
            this.H = b;
        ...
        var YUb = class {
          static A(a) {
            __c.Q(a, { sA: l4, HA: l4, mD: l4, Wx: l4 });
          }
          get sA() {
            const a = this.fz.Af.sA.color,
              b = this.fz.Af.sA.pb;
            if (a) return { type: "color", color: a };
            if (b.ref) return { type: "gradient", pb: b.ref };
          }
          get HA() {
            const a = this.fz.Af.HA.color,
              b = this.fz.Af.HA.pb;
            if (a) return { type: "color", color: a };
            if (b.ref) return { type: "gradient", pb: b.ref };
          }
          get mD() {
            if (!this.sA) return "#000000";
            switch (this.sA.type) {
              case "color":
                return this.sA.color;
              case "gradient":
                return this.sA.pb.lm[0].color;
              default:
                throw new F(this.sA);
            }
          }
          get Wx() {
            if (!this.HA) return "#000000";
            switch (this.HA.type) {
              case "color":
                return this.HA.color;
              case "gradient":
                return this.HA.pb.lm[0].color;
              default:
                throw new F(this.HA);
            }
          }
        ...
        ZUb = ({ Ljb: a, q9a: b }) => {
          ...
          return (a.status === 1 && b.status === 1 && a.YZ !== b.YZ) || c;
        };
        __c.tOa = {
          Q8a: function (a, b, c, d, e, f, g, h, k) {
            g.Sg("forms");
            const { gEb: l } = d !== null && d !== void 0 ? d : {},
              m = h.Bz("ui.rendering.form"),
              n = { root: new EUb(), option: new EUb() },
              p = new WUb(b);
            return {
              gsa: VUb,
              GA: UUb,
                  ...
                  var r,
                    t = GUb(
                      ...
                      () => {
                        const u = q.Af.mH,
                          x = q.Af.type,
                          y = l.get({ Bqa: q.Af.id, Eg: a, Paa: c });
                        r === null || r === void 0 || r.unsubscribe();
                        x === "poll" &&
                          (r = y
                            .lGb({ BEb: () => q.Af.mH })
                            .subscribe(({ results: A, mH: z }) => {
                              s4(() => {
                                const B = new Map(q.jk.UA);
                                var E;
                                B.set(z, {
                                  ...((E = B.get(z)) !== null && E !== void 0
                                    ? E
                                    : q4),
                                  results: A,
                                });
                        ...
                        y.getSettings({ AEb: () => q.Af.ZW }).subscribe((A) => {
                          const z = q.jk.settings;
                          let B = A;
                          if (
                            A.status === 1 &&
                            !q.Af.ZW &&
                            ...
                            const K =
                              (I =
                                (E = q.Af.fields.first()) === null ||
                                E === void 0
                                  ? void 0
                                  : E.value.A8a.toArray()) !== null &&
                              I !== void 0
                                ? I
                                : [];
                            B = {
                          ...
                          ZUb({ Ljb: B, q9a: z }) &&
                            y.QDb({ mH: u, ZW: q.Af.ZW }).then(
                              FUb((K) => {
                                if (K.ok) {
                                  var H = new Map(q.jk.UA);
                                  if (K.value) {
                                    var M;
                                    K = K.value;
                                    var O;
                                    const aa =
                                      (O =
                                        (M = q.Af.fields.first()) === null ||
                                        M === void 0
                                          ? void 0
                                          : M.value.id) !== null && O !== void 0
                                        ? O
                                        : "";
                                    var S;
                                    ({ Hf: M } =
              ...
              render: (q, r) => {
                var t = $Tb(q);
                if (l && a) {
                  var w = l.get({ Bqa: q.Af.id, Eg: a, Paa: c });
                  w = dUb(q, t, w, e, f, m);
                }
                a: {
                  var u = q.Af,
                  ...
                  switch (u.type) {
                    ...
                    case "quiz":
                      ...
                      if (O && M && u) {
                        ...
                        M = A.Ora
                          ? void 0
                          : lUb({ direction: z, text: O.label, background: M });
                        O = AUb({
                          rO: kUb(w),
                          direction: z,
                          options: O.options,
