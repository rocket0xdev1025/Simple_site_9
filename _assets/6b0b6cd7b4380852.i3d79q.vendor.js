...
(self.webpackChunk_canva_web = self.webpackChunk_canva_web || []).push([
  [69588],
  {
    ...
    519427: (e, t, n) => {
      ...
      function ue(e, t, n, r) {
        var a,
          i = ce(e, this, t, n, null == (a = this.options_) ? void 0 : a.bound);
      ...
      function ke(e, t, n, r) {
        ...
        if (r !== e.target_ && "function" == typeof n.value)
          return w(n.value)
            ? (null != (l = this.options_) && l.autoBind ? wn.bound : wn).make_(
                e,
                t,
                n,
                r
              )
            : (null != (o = this.options_) && o.autoBind ? qt.bound : qt).make_(
                e,
                t,
                n,
                r
      ...
      var Ce = ve("observable"),
        Pe = ve("observable.ref", { enhancer: J }),
        Ne = ve("observable.shallow", {
          enhancer: function (e, t, n) {
            return null == e || Mr(e) || br(e) || Sr(e) || Cr(e)
              ? e
              : Array.isArray(e)
      ...
      var ze,
        ...
        je = "computed",
        Ie = fe(je),
        Ve = fe("computed.struct", { equals: Y.structural }),
        Fe = function (e, t) {
      ...
      function ot(e) {
        switch (e.dependenciesState_) {
          ...
          case tt.POSSIBLY_STALE_:
            for (
              var t = ht(!0), n = dt(), r = e.observing_, a = r.length, i = 0;
              i < a;
              i++
            ) {
              var o = r[i];
      ...
      var At = (function () {
        ...
        return (
          ...
          (t.schedule_ = function () {
            this.isScheduled ||
              ((this.isScheduled = !0), wt.pendingReactions.push(this), Mt());
          }),
      ...
      var Vt = "action",
        ...
        Ut = "<unnamed action>",
        Bt = te(Vt),
        Ht = te("action.bound", { bound: !0 }),
        $t = te(Ft, { autoAction: !0 }),
        Wt = te("autoAction.bound", { autoAction: !0, bound: !0 });
      function Kt(e) {
        return function (t, n) {
          return m(t)
            ? We(t.name || Ut, t, e)
            ...
            ? We(t, n, e)
            : W(n)
            ? (e ? $t : Bt).decorate_20223_(t, n)
            : b(n)
            ? $(t, n, e ? $t : Bt)
            : b(t)
            ? H(te(e ? Ft : Vt, { name: t, autoAction: e }))
            : void 0;
        };
      }
      var Qt = Kt(!1);
      ...
      function cn(e) {
        ...
        if (
          (void 0 !== a &&
            (wt.useProxies =
              a === un || (a !== ln && "undefined" != typeof Proxy)),
        ...
        wn = Object.assign(function (e, t) {
          ...
          var n = e,
            ...
            a = function () {
              ...
              return (
                (l.cancel = Qt(r + " - runid: " + a + " - cancel", function () {
                  try {
                    o && kn(o);
      ...
      function En(e, t, n) {
        var r;
        return (
          Sr(e) || br(e) || Ze(e) ? (r = Yr(e)) : Mr(e) && (r = Yr(e, t)),
      ...
      function Tn(e, t) {
        return (
          !!e &&
          (void 0 !== t
            ? !!Mr(e) && e[K].values_.has(t)
            : Mr(e) || !!e[K] || q(e) || jt(e) || rt(e))
        );
      }
      function An(e) {
        return Tn(e);
          ...
          return (
            ...
            (t.addValue_ = function (e, t) {
              ...
              this.keysAtom_,
                Qn(function () {
                  var r,
                    a = new Je(t, n.enhancer_, "ObservableMap.key", !1);
                  n.data_.set(e, a),
                    (t = a.value_),
      ...
      var Nr = Object.create(null),
        ...
        Ar = (function () {
          ...
          return (
            ...
            (t.get_ = function (e) {
              return (
                wt.trackingDerivation && !T(this.target_, e) && this.has_(e),
                this.target_[e]
              );
            }),
      ...
      (Ir = Hr),
        ...
        Object.setPrototypeOf
          ? Object.setPrototypeOf(Ir.prototype, Vr)
          : void 0 !== Ir.prototype.__proto__
          ? (Ir.prototype.__proto__ = Vr)
          : (Ir.prototype = Vr);
      var $r = (function (e) {
        function t(t, n, r, a) {
          var i;
      ...
      function na(e, t, n, r, a) {
        ...
        if ((r.push(e), a.push(t), l)) {
          ...
          for (; c--; ) if (!na(e[c], t[c], n - 1, r, a)) return !1;
        } else {
          var f,
            d = Object.keys(e);
    ...
    684391: (e, t, n) => {
      ...
      function yi(e) {
        ...
        function g(a, l, u, s) {
          ...
          for (
            var f = (c = null), v = l, g = (l = 0), m = null, b = u.next();
            null !== v && !b.done;
            g++, b = u.next()
          ) {
          ...
          for (v = r(a, v); !b.done; g++, b = u.next())
            null !== (b = h(v, a, g, b.value, s)) &&
              (e &&
                null !== b.alternate &&
          ...
          return ("string" == typeof o && "" !== o) || "number" == typeof o
            ? ((o = "" + o),
              null !== i && 6 === i.tag
                ...
                : (n(r, i), ((i = js(o, r.mode, u)).return = r), (r = i)),
              l(r))
            : n(r, i);
        };
      }
      ...
      function Ni(e, t) {
        (Si = e),
          ...
          null !== (e = e.dependencies) &&
            null !== e.firstContext &&
            (!!(e.lanes & t) && (yl = !0), (e.firstContext = null));
      }
      function Ti(e) {
      ...
      function $o(e, t, n) {
        return 21 & io
          ? (lr(n, t) ||
              ((n = vt()), (oo.lanes |= n), (Du |= n), (e.baseState = !0)),
            t)
      ...
      function ul(e, t, n, r) {
        ...
        "object" == typeof i && null !== i
          ? (a.context = Ti(i))
          : ((i = La(t) ? Ta : Pa.current), (a.context = Aa(e, i))),
      ...
      function Sl(e, t, n, r, a) {
        if (null !== e) {
          ...
          if (ur(i, r) && e.ref === t.ref) {
            if (((yl = !1), (t.pendingProps = r = i), !(e.lanes & a)))
      ...
      function Cl(e, t, n, r, a) {
        ...
        if ((Ni(t, a), null === t.stateNode))
          Hl(e, t), ol(t, n, r), ul(t, n, r, a), (r = !0);
        else if (null === e) {
          var o = t.stateNode,
            l = t.memoizedProps;
          o.props = l;
      ...
      function Bl(e, t, n) {
        var r = t.pendingProps,
          a = r.revealOrder,
          i = r.tail;
        if ((_l(e, t, r.children, n), 2 & (r = Zi.current)))
          (r = (1 & r) | 2), (t.flags |= 128);
        else {
      ...
      function Es(e, t, n) {
        ...
        null !== r && r.delete(t),
          ...
          Nu === e &&
            (Au & n) === n &&
            (4 === zu ||
            (3 === zu && (130023424 & Au) === Au && 500 > Xe() - Uu)
              ? ds(e, 0)
              : (Iu |= n)),
          rs(e, t);
      }
      ...
      function zs(e, t, n, r, a, o) {
        ...
        return (
          ((t = As(l, n, t, a)).elementType = e), (t.type = r), (t.lanes = o), t
        );
      }
      function Ms(e, t, n, r) {
      ...
      function Is(e, t, n) {
        return (
          ((t = As(4, null !== e.children ? e.children : [], e.key, t)).lanes =
            n),
          (t.stateNode = {
      ...
      (Gs.prototype.render = qs.prototype.render =
        ...
        (Pe = ss),
        (Ne = cs);
      var ec = { usingClientEntryPoint: !1, Events: [ya, _a, wa, Oe, Ce, ss] },
        tc = {
